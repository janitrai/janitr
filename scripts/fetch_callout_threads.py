...
def main():
    ...
    for i, callout in enumerate(callouts):
        ...
        print(f"[{i+1}/{len(callouts)}] Fetching callout tweet {tweet_id} (flagged: @{handle})...")
        ...
        if parent:
            ...
            print(f"  Parent: @{parent_extracted['handle']}: {parent_extracted['text'][:80]}...")
        else:
        ...
        if grandparent:
            ...
            print(f"  Grandparent: @{grandparent_extracted['handle']}: {grandparent_extracted['text'][:80]}...")
